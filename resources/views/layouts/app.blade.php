...
<html lang="en">
  <head>
    <title>FanteraSafaris - Free Bootstrap 4 Template by Colorlib</title>
    <meta charset="utf-8">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="index.html">FanteraSafaris.</a>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">FanteraSafaris</h2>
