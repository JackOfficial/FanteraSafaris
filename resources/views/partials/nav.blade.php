    ...
    <div class="collapse navbar-collapse" id="ftco-nav">
      <ul class="navbar-nav ml-auto align-items-center">
        ...
        <li class="nav-item cta ml-lg-2">
            <a href="https://wa.me/256751115949" class="nav-link bg-success text-white shadow-sm d-flex align-items-center" style="border-radius: 50px; padding: 8px 18px !important; font-size: 12px; font-weight: 700;">
                <i class="fab fa-whatsapp mr-2" style="font-size: 16px;"></i> Plan Trip
            </a>
        </li>
      </ul>
    </div>
