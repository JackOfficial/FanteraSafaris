...
<div x-data="{ activeDay: 0 }">
    ...
    @push('styles')
        ...
        <style>
            ...
            .itinerary-header { cursor: pointer; background: #f8f9fa; transition: 0.2s; }
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="itinerary-builder">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h5 class="font-weight-bold mb-0">Detailed Itinerary</h5>
                                <span class="badge badge-secondary">{{ count($itinerary) }} Days</span>
                            </div>
                                ...
                                <div class="card mb-2 border-pink shadow-sm" wire:key="day-{{ $index }}">
                                    ...
                                    <div class="card-header itinerary-header p-2 d-flex justify-content-between align-items-center" 
                                        ...
                                        <div>
                                            ...
                                            <span class="small font-weight-bold text-muted" x-show="activeDay !== {{ $index }}">
                                                {{ $day['title'] ?: '(No Title Set)' }}
                                            </span>
                                        </div>
                                        <i class="fas" :class="activeDay === {{ $index }} ? 'fa-chevron-up' : 'fa-chevron-down'"></i>
                                    </div>

                                    {{-- Accordion Body --}}
                                    <div class="card-body p-3" x-show="activeDay === {{ $index }}" x-collapse x-cloak>
                                        <div class="d-flex justify-content-end mb-2">
                                            <button type="button" wire:click="removeDay({{ $index }})" class="btn btn-xs btn-outline-danger"><i class="fas fa-trash"></i> Delete Day</button>
                                        </div>
                        ...
                        <div class="pb-5">
                            <button type="submit" class="btn btn-pink btn-lg btn-block shadow-lg py-3 font-weight-bold">
                                <span wire:loading.remove wire:target="save"><i class="fas fa-check-circle mr-2"></i> PUBLISH SAFARI</span>
