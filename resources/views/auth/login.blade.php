        ...
        <div class="container-fluid about  py-2">
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-md-6">
                        <img class="mb-4 d-block mx-auto" style="width: 200px;" src="{{ asset('front/images/FanteraSafaris_logo.png') }}" alt="Icon">
                    
                        <div class="card rounded shadow">
                          <div class="card-header">Login to FanteraSafaris</div>
                          <div class="card-body">
