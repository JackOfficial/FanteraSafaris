<x-layout 
    title="The Fantera Legacy | About Fantera Safaris"
    metaDescription="Learn about Fantera Safaris' commitment to luxury travel, wildlife conservation, and community empowerment across East Africa."
>
    <x-slot:styles>
        <style>
            .btn-warning {
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="{{ asset('front/images/about_us.jpg') }}" class="img-fluid rounded shadow" alt="Luxury Safari Experience">
                </div>
                <div class="col-md-6 pl-md-5">
                    <h2 class="font-weight-bold mb-4">Curating Extraordinary Encounters</h2>
                    <p>At <strong>Fantera Safaris</strong>, we specialize in bespoke luxury expeditions across Uganda, Kenya, Tanzania, and Rwanda — bridging the gap between untamed wilderness and refined comfort.</p>
                    <p>From private gorilla trekking permits to exclusive mobile camps positioned along the Great Migration route, we manage every detail of your East African odyssey with precision and care.</p>
                    <div class="mt-4">
                        <a href="/contact" class="btn btn-warning font-weight-bold px-4 py-2 text-white">
                            Plan Your Safari
                        </a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row text-center mb-5">
                <div class="col-md-8 mx-auto">
                    <span class="text-warning text-uppercase font-weight-bold" style="letter-spacing:2px; font-size:13px;">Our Philosophy</span>
                    <h2 class="font-weight-bold mt-2">Our Commitment</h2>
                    <p class="text-muted">Luxury travel rooted in conservation, authenticity, and meaningful impact.</p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="commitment-card text-center p-5 bg-white rounded shadow-sm h-100">
                        <div class="icon-box mb-4"><i class="fas fa-paw"></i></div>
                        <h5 class="font-weight-bold mb-3">Conservation First</h5>
                        <p class="text-muted mb-0">We actively support wildlife preservation and sustainable tourism initiatives that protect Africa’s fragile ecosystems.</p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="commitment-card text-center p-5 bg-white rounded shadow-sm h-100">
                        <div class="icon-box mb-4"><i class="fas fa-hands-helping"></i></div>
                        <h5 class="font-weight-bold mb-3">Community Empowerment</h5>
                        <p class="text-muted mb-0">Our safaris directly contribute to local communities through employment, partnerships, and ethical sourcing.</p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="commitment-card text-center p-5 bg-white rounded shadow-sm h-100">
                        <div class="icon-box mb-4"><i class="fas fa-globe-africa"></i></div>
                        <h5 class="font-weight-bold mb-3">Authentic Experiences</h5>
                        <p class="text-muted mb-0">We avoid mass tourism and curate immersive journeys that connect travelers to Africa’s true spirit.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="faqAccordion">
                ...
                <div class="card mb-3 border-0 shadow-sm">
                    <div class="card-header bg-white" id="heading{{ $faq['id'] }}">
                        <button class="btn btn-link btn-block text-left font-weight-bold text-dark text-decoration-none p-0" data-toggle="collapse" data-target="#faq{{ $faq['id'] }}">
                            <i class="fas fa-plus-circle mr-2 text-warning"></i> {{ $faq['q'] }}
                        </button>
                    </div>
    ...
    <section class="py-5 text-center text-white" style="background:#1b4332;">
        <div class="container">
            ...
            <a href="/contact" class="btn btn-warning btn-lg font-weight-bold px-4 py-3 text-white">
